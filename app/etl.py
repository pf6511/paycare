...
#def main():
    #print("ETL lancé")
    # ici tu mettras plus tard ta logique
...
def get_input_output_paths():
    input_file = os.getenv("INPUT_FILE", "data/input/input_data.csv")
    output_file = os.getenv("OUTPUT_FILE", "data/output/output_data.csv")
...
if __name__ == "__main__":
    input_file, output_file = get_input_output_paths()
